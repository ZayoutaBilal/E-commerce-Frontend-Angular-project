...
@Component({
  selector: 'app-header-customer-service',
  templateUrl: './header-customer-service.component.html',
  styleUrls: ['./header-customer-service.component.css']
})
export class HeaderCustomerServiceComponent {
  public errorMsg:any[] = [];
  public divTop = '-200px';
